...
const idlFactory = ({ IDL }) => {
  ...
  const DRC721 = IDL.Service({
    ...
    'get_blob' : IDL.Func([IDL.Nat8], [IDL.Text], []),
    'get_text' : IDL.Func([IDL.Text], [IDL.Text], []),
...
document.querySelector("form").addEventListener("submit", async (e) => {
  ...
  const result = await _declarations_hello__WEBPACK_IMPORTED_MODULE_0__.hello.get_blob(blob);
